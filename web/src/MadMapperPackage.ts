...
function guideLines(
  ...
  return [
    ...
    "SCULPTURE OUTPUT REQUIRES LIVE-020 HARDWARE VALIDATION",
    "",
    ...
    "3. LOO/UME sends only complete mapped frames to WLED through WLAN DDP.",
    "4. Do not send MadMapper Art-Net directly to WLED.",
    "5. Use the local preview until LIVE-020 passes its physical test.",
    "",
    "WLED WLAN DDP",
