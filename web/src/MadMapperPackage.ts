...
function guideLines(
  ...
  return [
    ...
    "DRAFT - SCULPTURE OUTPUT REQUIRES LIVE-020 VALIDATION",
    "",
    ...
    "",
    "PLANNED LIVE SCULPTURE OUTPUT",
    "1. Keep MadMapper Art-Net output on loopback at 127.0.0.1.",
    "2. LIVE-020 will send complete mapped frames to WLED through WLAN DDP.",
    "3. Do not send MadMapper Art-Net directly to WLED.",
    "4. Use the local preview until LIVE-020 passes its physical test.",
    "",
    "WLED WLAN DDP",
    "1. Keep the existing private WLED address and DDP port 4048.",
    "2. Keep a finite realtime timeout and the selected native-preset fallback.",
    "3. Do not apply the installed ledmap twice.",
    "",
    "BOUNDED TEST",
