...
export function validateGeneratedStructuralManifest(value: unknown): void {
  ...
  if ((roleCounts.get("part") ?? 0) < 1) {
    throw new Error("Generated structure requires at least one part artifact.");
  }
  for (const role of ["preview", "package", "analysis", "report"] as const) {
